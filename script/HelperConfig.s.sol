...
contract HelperConfig is Script {
    struct NetworkConfig{
        ...
        //since we'll be working with different chains in future , just make that part robust, we'll be putting it via this deployerKey
        uint256 deployerKey;
    }
    ...
    function getOrCreateAnvilEthConfig() public returns(NetworkConfig memory){
            if(activeNetworkConfig.wbtcUsdPriceFeedAddress!=address(0) ){
