...
contract DSCEngine is ReentrancyGuard {
    ...
    */
    ...
    function burnDSC(address tokenCollateralAddress, uint256 amount) public moreThanZero(amount) {
    ...
    function getTokenCollateralPriceFeed(address token) public returns (address) {
